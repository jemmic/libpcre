...
func getrlimit(resource int32, rlim []rlimit) int32 {
	return int32(C.getrlimit(C.int(int(resource)), (*C.struct_rlimit)(unsafe.Pointer(&rlim[0]))))
}

func setrlimit(resource int32, rlim []rlimit) int32 {
	return int32(C.setrlimit(C.int(int(resource)), (*C.struct_rlimit)(unsafe.Pointer(&rlim[0]))))
}

func regcomp(preg []regex_t, pattern []byte, cflags int32) int32 {
	ppreg := (*C.struct___0)(unsafe.Pointer(&preg[0]))
...
func regexec(preg []regex_t, str []byte, nmatch size_t, pmatch []regmatch_t, eflags int32) int32 {
	ppreg := (*C.struct___0)(unsafe.Pointer(&preg[0]))
	ppmatch := (*C.struct___1)(unsafe.Pointer(&pmatch[0]))
