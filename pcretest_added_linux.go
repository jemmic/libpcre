...
func getrlimit(resource int32, rlim *rlimit) int32 {
	return int32(C.getrlimit(C.__rlimit_resource_t(resource), (*C.struct_rlimit)(unsafe.Pointer(rlim))))
}

func setrlimit(resource int32, rlim *rlimit) int32 {
	return int32(C.setrlimit(C.__rlimit_resource_t(resource), (*C.struct_rlimit)(unsafe.Pointer(rlim))))
}

func regcomp(preg *regex_t, pattern *byte, cflags int32) int32 {
	ppreg := (*C.struct_re_pattern_buffer)(unsafe.Pointer(preg))
...
func regexec(preg *regex_t, str *byte, nmatch size_t, pmatch *regmatch_t, eflags int32) int32 {
	ppreg := (*C.struct_re_pattern_buffer)(unsafe.Pointer(preg))
	ppmatch := (*C.struct___0)(unsafe.Pointer(pmatch))
